...
def test_models():
    # 定义测试输入：batch_size=1，3通道彩色图像，输入分辨率为224x224
    input_tensor = torch.randn(1, 3, 512, 512)

    # # 测试CAresnet18
    # model_18 = CAresnet18(pretrained=False)
    # output_18 = model_18(input_tensor)
    # print("CAresnet18 output shape:", output_18.shape)
    #
    # # 测试CAresnet34
    model_34 = CAresnet34(pretrained=False)
    output_34 = model_34(input_tensor)
    print("CAresnet34 output shape:", output_34.shape)

    # 测试CAresnet50
    # model_50 = CAresnet50(pretrained=False)
    # output_50 = model_50(input_tensor)
    # print("CAresnet50 output shape:", output_50.shape)
