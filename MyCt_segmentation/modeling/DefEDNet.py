...
class DefED_Net(nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.firstconv = DefC(3, 64, 7, stride=2, padding=3, bias=False)
        ...
        self.finalconv2 = SeparableConv2d(64, 32, 3, padding=1)
...
#     # 实例化 DefED_Net 模型
#     model = DefED_Net(num_classes=3)
#     print(model)
#
#     # 创建一个模拟输入张量 (batch_size, channels, height, width)
#     input_tensor = torch.randn(1, 3, 512, 512)  # 1 张图片，1 个通道，256x256 尺寸
#
#     # 前向传播，计算输出
#     output = model(input_tensor)
#
#     print("输入尺寸:", input_tensor.shape)
#     print("输出尺寸:", output.shape)  # 预期为 (1, 3, 512, 512)