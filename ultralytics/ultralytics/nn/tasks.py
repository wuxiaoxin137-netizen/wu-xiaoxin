...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C2f_LEGM, C2f_LSBlock, C2f_MambaOut_LSConv, C2f_LFEM, LoGStem, C2f_RCB, C2f_TransMamba, C2f_EVS, C2f_EBlock, C2f_DBlock
        }:
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in {
                     ...
                     C2f_LSBlock, C2f_MambaOut_LSConv, C2f_LFEM, C2f_RCB, C2f_TransMamba, C2f_EVS, C2f_EBlock, C2f_DBlock
                     }:
