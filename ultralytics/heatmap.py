...
def get_params():
    params = {
        'weight': '/mnt/user/ultralytics-main601/runs/train/exp11/weights/last.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'LayerCAM',
...
if __name__ == '__main__':
    ...
    model(r'/mnt/user/ultralytics-main601/dataset/detect_data1/images/test/', 'ours')
